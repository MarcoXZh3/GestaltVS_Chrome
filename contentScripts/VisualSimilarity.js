...
function createSubtreeFromDOM(domElement, parentNode, treeType) {
  if (treeType != 'VT' || isElementVisible(domElement)) {
    ...
    // Set the attributes
    var parent = domElement.offsetParent, left = domElement.offsetLeft, top = domElement.offsetTop;
    while (parent) {
    ...
    node.setAttribute('right', (left + domElement.offsetWidth) + '');
